...
- UI text is localized via Android string resources (`strings.xml`), with Dutch (NL), German (DE), and French (FR) translations. Per-app language setting via AppCompat. Defaults to system locale.
