...
SweetSpot je k dispozici na [Google Play](https://play.google.com/store/apps/details?id=today.sweetspot). Zdrojový kód je dostupný na [GitHubu](https://github.com/jmerhar/sweetspot-android) pod licencí GPL v3.
{{< /faq >}}
