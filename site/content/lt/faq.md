...
SweetSpot rodo **kitos dienos biržos kainas** — didmenines elektros kainas, kurias rinka nustato dieną prieš pristatymą (dar vadinamas spot kainomis). Šios kainos **neapima** PVM, energijos mokesčių, tinklo mokesčių ar tiekėjo maržos, kurie skiriasi priklausomai nuo šalies ir tiekėjo.

Vis dėlto kainos naudingos norint sužinoti, kada elektra pigiausia — o tai ir yra pagrindinis programėlės tikslas. Pagal numatytuosius nustatymus išlaidos rodomos 1 kW apkrovai; nurodykite prietaiso galingumą arba įkraukite elektromobilį, ir įvertinimas atitiks realią apkrovą. Rytojaus kainos paprastai paskelbiamos po 13:00 CET.
{{< /faq >}}

{{< faq question="Ar man reikia specialios elektros sutarties?" >}}
Taip — kad iš tikrųjų sutaupytumėte, jums reikia **dinaminės (biržos arba valandinės) elektros sutarties**, kai jūsų mokama kaina seka kitos dienos rinką. SweetSpot parodo, kada tos kainos mažiausios, tačiau negali pakeisti to, kiek ima jūsų tiekėjas: taikant fiksuoto tarifo planą, kaina visą dieną vienoda, todėl elektros naudojimo laiko keitimas sąskaitos nesumažins.
{{< /faq >}}

{{< faq question="Ar SweetSpot gali padėti įkrauti elektromobilį?" >}}
Taip. Pridėkite savo automobilį — pasirinkite jį iš integruotos tūkstančių elektromobilių ir įkraunamų hibridų duomenų bazės arba rankiniu būdu įveskite baterijos talpą ir įkrovimo galią. Tada įveskite dabartinį ir norimą įkrovos lygį, o SweetSpot apskaičiuos, kiek truks įkrovimas (pagal baterijos talpą ir mažesniąją iš dviejų galių — automobilio AC ribos arba jūsų namų įkroviklio) ir suras pigiausią laiką prijungti.
{{< /faq >}}

{{< faq question="Ar galiu užtikrinti, kad bus paruošta iki tam tikro laiko?" >}}
Taip. Įjunkite neprivalomą **„Paruošti iki“** terminą ir pasirinkite laiką. Tada SweetSpot pagal numatymą pasiūlo pigiausią laiką, kuris suspėja baigtis iki tada — bet kuriam prietaisui ar elektromobilio įkrovimui (pavyzdžiui, įkrauta iki 7:00 ryto). Jei norite, vis tiek galite pasirinkti pigesnį laiką, kuris baigiasi kiek vėliau; SweetSpot pažymi, kai rodomas laikas baigiasi po jūsų nustatyto termino.
{{< /faq >}}

{{< faq question="Kodėl rekomenduojamas laikas nuolat keičiasi?" >}}
Kol atidarytas rezultatas, SweetSpot iš naujo tikrina kainas, o bėgant laikui jau praėję intervalai iškrenta, todėl rekomenduojamas laikas gali pasislinkti. Naudokite mygtukus **„Anksčiau“** ir **„Pigiau“**, kad pereitumėte tarp ankstesnės (kiek brangesnės) pradžios ir pigiausios — kiekvienas rodo, kiek ji brangesnė už rekomenduojamą laiką.
{{< /faq >}}
...
Wear OS programėlė sinchronizuoja prietaisus ir nustatymus iš telefono programėlės. Sinchronizavus, laikrodžio programėlė gauna kainas savarankiškai — todėl ji veikia net tada, kai telefonas nėra šalia, jei tik laikrodis turi prieigą prie interneto (Wi-Fi arba LTE).
