...
SweetSpot je dostupný na [Google Play](https://play.google.com/store/apps/details?id=today.sweetspot). Zdrojový kód je dostupný na [GitHube](https://github.com/jmerhar/sweetspot-android) pod licenciou GPL v3.
{{< /faq >}}
